...
const page = () => {
  ...
  return (
    <main className="relative min-h-screen w-full text-white overflow-hidden">
      ...
      <div className="relative min-h-screen inset-0 z-20  w-full overflow-hidden">
            ...
            {boxes.map((box, idx) => {
              ...
              return (
                <div
                  ...
                  ${
                    isOpen
                      ? "w-full h-48 shine-border flex items-center justify-center"
                      : ""
                  }
                  ${
                    isOut
                      ? "w-0 h-0 overflow-hidden opacity-0 p-0 m-0 border-none"
                      : "w-[30%] h-32 shine-border p-6"
                  }`}
                >
                  {isOpen ? (
